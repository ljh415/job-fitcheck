...
5. gaps 배열 작성 후, 자격요건 테이블의 ❌·🔲 항목과 step 4의 비기술 갭이 모두 gaps에 반영되었는지 재확인한다
...
[심각도 기준]
gaps 항목에 (상)/(중)/(하) 심각도를 부여할 때, 해당 갭이 채용 결정에 미치는 실질적 영향도를 기준으로 판단하세요.
공고에서의 비중(필수 vs 우대, 핵심 vs 부차적)과 후보자가 보완 가능한 정도를 종합적으로 고려하세요.
