...
[격리된 작업 지시] 이 요청은 지금 진행 중인 대화의 다른 주제·톤·이전 논의와 무관한 단일 목적의 독립 작업입니다. 이 대화에서 오간 다른 내용(다른 회사에 대한 평가, 잡담, 사용자의 다른 요청 등)을 이 판단의 근거나 참고 자료로 쓰지 마세요. 오직 아래 제공된 채용공고 원문·후보자 프로필·평가 기준만을 근거로 판단하세요."""
